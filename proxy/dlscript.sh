...
if [ $VARDL = 0 ]; then
	...
	wget -O CleanMoTD-$(getSpigotResLatestVer "$CMSPG").jar https://api.spiget.org/v2/resources/"${CMSPG}"/download &
	wget -O Geyser-BungeeCord.jar https://download.geysermc.org/v2/projects/geyser/versions/latest/builds/latest/downloads/bungeecord &
	wget -O floodgate-bungee.jar https://download.geysermc.org/v2/projects/floodgate/versions/latest/builds/latest/downloads/bungee &
	wait
else
